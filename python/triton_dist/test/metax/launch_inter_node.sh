...
MXSHMEM_ROOT=${THIRD_PARTY_DIR}/mxshmem/build/install

export LD_LIBRARY_PATH=${MXSHMEM_ROOT}/lib:$LD_LIBRARY_PATH
...
export MXSHMEM_BOOTSTRAP_UID_SOCK_IFNAME=ens12np0   #en,eth0,em,bond
