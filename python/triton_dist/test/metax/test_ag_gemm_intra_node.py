...
from triton_dist.kernels.metax import ag_gemm_intra_node, create_ag_gemm_intra_node_context
...
def matmul(a, b, c, BLOCK_M=128, BLOCK_N=128, BLOCK_K=128, stages=4, pipeline="cpasync", autotune=False):
    # Check constraints.
    ...
    compiled = kernel_consumer_gemm_1[grid](
            a,
            b,
            c,  #
            M,
